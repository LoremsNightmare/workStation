...
console.log('2',centimeterToMeter(1450));
...
function paperRequirements(first,second,third){
  return first * 100 + second * 200 + third * 300
}

console.log('3',paperRequirements(1,2,3));

//৪. একটা ফাংশন লিখবে। এই ফাংশনের নাম হবে bestFriend তারপর সেই ফাংশনে ইনপুট প্যারামিটার হিসেবে একটা array নিবে। সেই array এর মধ্যে তোমার সব ফ্রেন্ডের নাম থাকবে। এখন তোমার কাজ হচ্ছে যে ফ্রেন্ড এর নাম সবচেয়ে বড় সেই ফ্রেন্ড এর নাম রিটার্ন করে দেয়া। এই ক্ষেত্রে তুমি নামটা অর্থাৎ ফ্রেন্ডের নাম (স্ট্রিং) রিটার্ন করতে হবে। 

let jmFriend = ['jhankar', 'karina','jelebi baby', 'takim', 'emdadul', 'OC harun','hojachelebi']
...
console.log('4', bestFriend(jmFriend));
...
let jmTricky = [12,13,14,15,23,-24,25,36,-46,57,68,92,45];
...
function onlyPositive(arr){
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    if(element < 0){
      ...
      jmPossitive.push(element)
    }
  }
  return jmPossitive
}
console.log(onlyPositive(jmTricky));
